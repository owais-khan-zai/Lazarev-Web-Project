  ...
  return (
    <div className='lg:flex lg:w-full lg:gap-[3rem]'>
      ...
      <div className='mt-[22vw] sm:mt-[8.5rem] md:mt-[8rem] lg:mt-0 lg:w-[55%]'>
        <Review no='/01' review='"I had the pleasure of working wih Owais Khan backed by the amazing design team at lazarev, and I cannot recommend them highly enough. From start to finsh, he is excellent communicator and made the entire process incredibly smooth"' pic='./assests/review1.webp' name='Nick Chapman' Title='Chief Product Officer, Pika AI'/>

        <Review no='/02' review='"They care about the client and have a deep focus on solving problems efficiently"'pic='./assests/review2.webp' name='Jens mathiasson' Title='Chief Product Officer, Pika AI'/>
      </div>
    </div>
  )
}
